          ...
          <div className="grid md:grid-cols-3 gap-4">
            {best && (
              <div className="card p-5">
                ...
                <div className="mt-2 flex items-center gap-3">
                  <span className="text-3xl">{displayHabitIcon(best.icon)}</span>
                  <div>
            ...
            {longestLongest && (
              <div className="card p-5">
                ...
                <div className="mt-2 flex items-center gap-3">
                  <span className="text-3xl">{displayHabitIcon(longestLongest.icon)}</span>
                  <div>
                    <div className="font-semibold">
                      {longestLongest.name}
                    </div>
            ...
            {worst && (
              <div className="card p-5">
                ...
                <div className="mt-2 flex items-center gap-3">
                  <span className="text-3xl">{displayHabitIcon(worst.icon)}</span>
                  <div>
                    <div className="font-semibold">
                      {worst.name}
                    </div>
                    ...
                    <div key={s.habitId}>
                      <div className="flex items-center justify-between text-sm mb-1">
                        <div className="flex items-center gap-2 min-w-0">
                          <span className="text-lg shrink-0">{displayHabitIcon(s.icon)}</span>
