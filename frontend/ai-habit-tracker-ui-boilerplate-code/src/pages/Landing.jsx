    ...
    <div className="min-h-screen">
      <header className="max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-5 flex items-center justify-between gap-3">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="font-semibold text-base sm:text-lg truncate">AI Habit Tracker</span>
        </div>
        <nav className="flex items-center gap-1 sm:gap-2 shrink-0">
          ...
          <Link to="/login" className="btn-ghost px-2 sm:px-3">
            Log in
          </Link>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 pt-8 md:pt-16 pb-12 md:pb-16">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-6 items-center">
          <div className="lg:col-span-8 text-center lg:text-left order-2 lg:order-1">
            ...
            <p className="mt-5 text-soft text-base sm:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
          ...
          <div className="lg:col-span-4 order-1 lg:order-2 flex justify-center lg:-mr-36 overflow-hidden">
            <OrbitingHabits />
          </div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-16 border-t divider">
