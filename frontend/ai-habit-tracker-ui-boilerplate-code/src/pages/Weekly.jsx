...
import { displayHabitIcon } from "../utils/habitIcons.js";
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
        ...
        <div className="grid grid-cols-[auto_1fr_auto] sm:flex sm:items-center gap-2 w-full lg:w-auto">
          <button
          ...
          <div className="inline-flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-xl glass text-sm font-medium min-w-0">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <div className="card p-4">
              ...
              <div className="text-2xl font-semibold mt-1 truncate">
                {topHabit?.count ? (
                  <>
                    <span className="mr-1">{displayHabitIcon(topHabit.h.icon)}</span>
