...
export default function MobileNav() {
  ...
  return (
    <>
      <div className="md:hidden sticky top-0 z-20 glass border-b divider px-3 py-3 flex items-center justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="font-semibold truncate">AI Habit Tracker</div>
        </div>
      ...
      <nav className="md:hidden fixed bottom-0 inset-x-0 z-30 glass border-t divider grid grid-cols-5 gap-1 px-1 py-2">
        {[
          ...
          <NavLink
            ...
            to={to}
            className={({ isActive }) =>
              `flex flex-col items-center gap-0.5 px-1 py-1.5 rounded-lg text-[11px] sm:text-xs min-w-0 ${isActive
